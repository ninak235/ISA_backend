...
@Entity
@Table(name = "PickUpReservationToken")
public class PickUpReservationToken {
    ...
    public PickUpReservationToken(){
    }

    public PickUpReservationToken(Reservation reservation){
